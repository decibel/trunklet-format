...
Once trunklet-format is installed, you can add it to a database. If you're running
...
so:
    ...
    PGOPTIONS=--search_path=extensions psql -d mydb -f trunklet-format.sql

Dependencies
------------
The `trunklet-format` data type has no dependencies other than PostgreSQL.
